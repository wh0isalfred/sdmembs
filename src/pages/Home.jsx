        ...
        <div className="relative container-page py-20 sm:py-28 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-white/80 text-base sm:text-lg leading-relaxed mb-8 max-w-xl">
              Professional security services for businesses and institutions
              across Nigeria, delivered by trained personnel and supported by
              24/7 operations.
            </p>
      ...
      <div className="container-page grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-charcoal/70 leading-relaxed mb-8">
            ...
            security provider supporting businesses, institutions and industrial
            operations across Nigeria through regional offices and operational
            teams committed to integrity, discipline and excellence.
          </p>
      ...
      <div className="container-page py-16 sm:py-20 grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-white/75 leading-relaxed max-w-lg mb-6">
            Our head office, regional offices and operational teams coordinate
            trained personnel and dependable support for businesses and
          ...
          <div className="relative w-full max-w-[300px]">
            ...
            <div className="mt-6 space-y-2 px-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-white/70 text-xs font-semibold">Head Office</p>
              </div>
            </div>
          </div>
        </div>
